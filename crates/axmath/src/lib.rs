//! Math functions to support rust compiler
//!
//! Rust compiler builds source based on some intrinsics math functions, e.g., pow.
//! Specifically, we can implement a math lib for ArceOS.
//! But for simpleness, now just use libm.
//!
